...
function RightPanel({
  ...
  return (
    <div className="absolute right-3 top-3 w-60 bg-black/60 backdrop-blur-md border border-gray-400/30 p-3 text-sm overflow-y-auto max-h-[calc(100vh-4rem)] z-10">
      {/* Corner accents */}
